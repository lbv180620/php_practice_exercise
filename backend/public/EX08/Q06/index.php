                                        ...
                                        <td>
                                            <form action="./action.php" method="post" class="form-inline">
                                                ...
                                                <div class="form-check form-check-inline mb-3 mr-1">
                                                    <input type="radio" name="is_completed" id="is_completed1" value="0" class="form-check-input">
                                                    <label for="is_completed1" class="form-check-label">未完了</label>
                                                </div>

                                                <div class="form-check form-check-inline mb-3 mr-1">
                                                    <input type="radio" name="is_completed" id="is_completed2" value="1" class="form-check-input">
                                                    <label for="is_completed2" class="form-check-label">完了</label>
                                                </div>
